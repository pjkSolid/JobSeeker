...
using PJK.Jobseeker.Application;
using PJK.Jobseeker.Application.Contracts;
using PJK.Jobseeker.Identity;
using PJK.Jobseeker.Identity.Models;
using PJK.Jobseeker.Persistence;
using PJK.Jobseeker.WebAPI.Middleware;
using PJK.Jobseeker.WebAPI.Services;

namespace PJK.Jobseeker.WebAPI;
...
public static class StartupExtensions
{
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
        ...
        public static async Task ResetDatabaseAsync(this WebApplication app)
        {
            ...
            try
            {
                var context = scope.ServiceProvider.GetService<JobseekerDbContext>();
                if (context != null)
                {
